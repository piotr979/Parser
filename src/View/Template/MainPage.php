<h4>
Following data will be extracted and saved to CSV file
</h4>

<ul class="details">
<li>Tracking Number</li>
<li>PO Number</li>
<li>'Scheduled' date (format Y-m-d H:i)</li>
<li>Customer</li>
<li>Trade</li>
<li>NTE (as float - no formatting)</li>
<li>Store ID</li>
<li>Address (Street extracted separately)
<li>City</li>
<li>State (2 letters)</li>
<li>Zip code</li>
<li>Phone (as float number)</li>
</ul>

<button class="action-button" id="convert-button">Convert</button>
                            ...
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container">
                                    ...
                                    <tr>
                                        <td width="50%" align="left" valign="top" style="padding-right: 5px; max-width: 240px;" class="mobile">
                                            ...
                                            <h3 style="padding: 0; margin: 0; font-weight: 600; overflow-wrap: break-word;" id="customer">My new Customer
</h3>
                                        </td>
                                    ...
                                    <tr>
                                        <td width="50%" align="left" valign="top" style="padding-right: 5px; max-width: 240px;" class="mobile">
                                            ...
                                            <h3 style="padding: 0; margin: 0; font-weight: 600; overflow-wrap: break-word;" id="trade">HVAC</h3>
                                        </td>
                                        <td height="12" style="height: 12px;" class="mobile vertical-column-space"></td>
                                        <td width="50%" align="left" valign="top" style="max-width: 240px;" class="mobile">
                                ...
                                <tr>
                                    ...
                                    <td width="50%" align="left" valign="top" style="max-width: 240px;" class="mobile">
                                        ...
                                        <h3 style="padding: 0; margin: 0; font-weight: 600; overflow-wrap: break-word;" id="nte">$1,000.00</h3>
                                    </td>
                                </tr>
                            </tbody></table>
                        </td>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container">
                                    ...
                                    <tr>
                                        <td width="50%" align="left" valign="top" style="padding-right: 5px; max-width: 240px;" class="mobile">
                                            ...
                                            <h3 style="padding: 0; margin: 0; font-weight: 600; overflow-wrap: break-word;" id="po_number">11111q1111</h3>
                                        </td>
                                        <td height="12" style="height: 12px;" class="mobile vertical-column-space"></td>
                                        <td width="50%" align="left" valign="top" style="max-width: 240px;" class="mobile">
                                            <div style="font-size: 12px; color: gray;">Tracking Number</div>
                                            <h3 style="padding: 0; margin: 0; font-weight: 600; overflow-wrap: break-word;" id="wo_number">22222e2222</h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="28" style="height: 28px;">&nbsp;</td>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <tr>
                                                    <td align="left" style="max-width: 480px;" class="mobile-col-2">
                                                        ...
                                                        <h3 style="padding: 0; margin: 0; font-weight: 600; overflow-wrap: break-word;" id="location_name">MNC-123</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="28" style="height: 28px;">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td align="left" style="max-width: 480px;" class="mobile-col-2">
                                                        ...
                                                        <h3 style="padding: 0; margin: 0; font-weight: 600; overflow-wrap: break-word;">
                                                            <a href="tel:440-878-3000" target="_blank" style="color: black; display: inline-block;" id="location_phone">999-111-2233</a>
                                                        </h3>
                                                    </td>
                                                </tr>
                                                <tr>
